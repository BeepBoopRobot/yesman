...
object DictionaryEnc {
    ...
    fun main(args: Array<String>) {
        ...
        {
            if(spy.containsKey(words.get(i)))
            {
                code.add(spy.get(words.get(i)))
            }
        }
        println(words)
        println(code)
        println(spy)
        println("Length of input string " + input.length + " characters.")
